                ...
                response = openai.ChatCompletion.create(
                    ...
                    messages=[
                        ...
                        {"role": "user", "content": f"""
                                ...
                                Example:
                                Text: 'The flight was amazing, the staff were friendly, and the seats were comfortable.'
                                Response: 'positive'

                                Text: 'The flight was delayed, the food was terrible, and the seats were cramped.'
                                Response: 'negative'

                                Text: 'The flight was okay, nothing special to mention.'
                                Response: 'neutral'
